...
progress_filename_test = '..CB2/DNN/batch300/log_files/test/drug_like_test-' + neural_net_present + '_' + test_type  + '.csv'
...
progress_filename_test = '../CB2/DNN/ecfp_screen_test/test/drug_like_test_' + neural_net_present + '_' + test_type  + '.csv'
output_test_df = pd.DataFrame()
for counter, experiment_list in enumerate(expr_list_of_lists):
    temp_test_df = pd.DataFrame()
    # print counter, experiment_list
